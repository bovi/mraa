...
#include "riscv/visionfive2.h"
#include "common.h"

 #define PLATFORM_NAME_VISIONFIVE "VisionFive-v2"

// current have no TRM doc of JH7100, just write a number.
...
mraa_visionfive_v2()
{
    ...
    b->platform_name = PLATFORM_NAME_VISIONFIVE;
    ...
    /* capabilities matrix
    valid:1;     < Is the pin valid at all 
    gpio:1;      < Is the pin gpio capable 
    pwm:1;       < Is the pin pwm capable 
    fast_gpio:1;  Is the pin fast gpio capable 
    spi:1;        Is the pin spi capable 
    i2c:1;        Is the pin i2c capable 
    aio:1;        Is the pin analog input capable 
    uart:1;       Is the pin uart capable 
    */
    ...
    b->pins[16].capabilities = (mraa_pincapabilities_t){ 1, 1, 0, 0, 0, 0, 0, 1 };
    ...
    b->pins[18].capabilities = (mraa_pincapabilities_t){ 1, 1, 0, 0, 0, 0, 0, 1 };
